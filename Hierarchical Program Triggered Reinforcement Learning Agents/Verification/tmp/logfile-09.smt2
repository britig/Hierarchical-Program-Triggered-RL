...
; ------------------------------------------------------------
; ---------- NNAgent___init__ ----------
(declare-const _cthread_156@0@09 $Ref)
(declare-const _caller_measures_156@1@09 Seq<Measure$>)
(declare-const _residue_156@2@09 $Perm)
(declare-const self@3@09 $Ref)
(declare-const vehicle@4@09 $Ref)
(declare-const target_speed@5@09 $Ref)
(declare-const vehicle_list@6@09 $Ref)
(declare-const _current_wait_level_156@7@09 $Perm)
(declare-const _cthread_156@8@09 $Ref)
(declare-const _caller_measures_156@9@09 Seq<Measure$>)
(declare-const _residue_156@10@09 $Perm)
(declare-const self@11@09 $Ref)
(declare-const vehicle@12@09 $Ref)
(declare-const target_speed@13@09 $Ref)
(declare-const vehicle_list@14@09 $Ref)
(declare-const _current_wait_level_156@15@09 $Perm)
(push) ; 1
(declare-const $t@16@09 $Snap)
(assert (= $t@16@09 ($Snap.combine ($Snap.first $t@16@09) ($Snap.second $t@16@09))))
(assert (= ($Snap.first $t@16@09) $Snap.unit))
; [eval] _cthread_156 != null
(assert (not (= _cthread_156@8@09 $Ref.null)))
(assert (=
  ($Snap.second $t@16@09)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@16@09))
    ($Snap.second ($Snap.second $t@16@09)))))
(assert (= ($Snap.first ($Snap.second $t@16@09)) $Snap.unit))
; [eval] issubtype(typeof(_cthread_156), Thread_0())
; [eval] typeof(_cthread_156)
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_156@8@09) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second $t@16@09))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@16@09)))
    ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@16@09))) $Snap.unit))
; [eval] self != null
(assert (not (= self@11@09 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@16@09)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@16@09))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))
(push) ; 2
(assert (not (=
  526620359159434342146756288111005262
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))
(push) ; 2
(assert (not (=
  2261817219997544549373515003693597740981374542
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))
(push) ; 2
(assert (not (=
  41311862561228097419861904740777028054620672394380115366859853390
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))
(push) ; 2
(assert (not (=
  2057743997646652586209098359459406
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))
(push) ; 2
(assert (not (=
  664816698780718148718299689247834100430016695886
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))))
(push) ; 2
(assert (not (=
  72278396927994961140698856492345702063570711301710
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))))
(push) ; 2
(assert (not (=
  10142612326481466590969612020568890212961870
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))
  $Snap.unit))
...
; [eval] typeof(self)
; [eval] NNAgent()
(assert (issubtype<Bool> (typeof<PyType> self@11@09) (as NNAgent<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))))
  $Snap.unit))
...
; [eval] typeof(vehicle)
; [eval] Vehicle()
(assert (issubtype<Bool> (typeof<PyType> vehicle@12@09) (as Vehicle<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))))
  $Snap.unit))
...
; [eval] float()
(assert (issubtype<Bool> (typeof<PyType> target_speed@13@09) (as float<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))))))
  $Snap.unit))
...
; [eval] list(Vehicle())
; [eval] Vehicle()
(assert (issubtype<Bool> (typeof<PyType> vehicle_list@14@09) (list<PyType> (as Vehicle<PyType>  PyType))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09))))))))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@16@09)))))))))))))))))
  $Snap.unit))
; [eval] self != null
...
; unknown
(push) ; 2
(declare-const $t@17@09 $Snap)
(assert (= $t@17@09 ($Snap.combine ($Snap.first $t@17@09) ($Snap.second $t@17@09))))
(assert (= ($Snap.first $t@17@09) $Snap.unit))
; [eval] (forperm _r_16: Ref [_r_16.MustReleaseBounded] :: Level(_r_16) <= _current_wait_level_156)
(assert (=
  ($Snap.second $t@17@09)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@17@09))
    ($Snap.second ($Snap.second $t@17@09)))))
(assert (= ($Snap.first ($Snap.second $t@17@09)) $Snap.unit))
; [eval] (forperm _r_16: Ref [_r_16.MustReleaseUnbounded] :: Level(_r_16) <= _current_wait_level_156)
(assert (=
  ($Snap.second ($Snap.second $t@17@09))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@17@09)))
    ($Snap.second ($Snap.second ($Snap.second $t@17@09))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@17@09))) $Snap.unit))
; [eval] _residue_156 <= _current_wait_level_156
(assert (<= _residue_156@10@09 _current_wait_level_156@15@09))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@17@09)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@17@09))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@09)))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@09))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@09)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@09))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@09)))))
  $Snap.unit))
...
; [eval] Vehicle()
(assert (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@17@09)))))) (as Vehicle<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@09)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@09))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@09)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@09))))))
  $Snap.unit))
...
(assert (object___eq__ $Snap.unit ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@17@09))))) vehicle@12@09))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@17@09))))))
  $Snap.unit))
(pop) ; 2
...
; [exec]
; var _err: Ref
(declare-const _err@18@09 $Ref)
; [exec]
; var self_8: Ref
(declare-const self_8@19@09 $Ref)
; [exec]
; var vehicle_3: Ref
(declare-const vehicle_3@20@09 $Ref)
; [exec]
; var target_speed_0: Ref
(declare-const target_speed_0@21@09 $Ref)
; [exec]
; var vehicle_list_1: Ref
(declare-const vehicle_list_1@22@09 $Ref)
; [exec]
; var arg: Ref
(declare-const arg@23@09 $Ref)
; [exec]
; var arg_13: Ref
(declare-const arg_13@24@09 $Ref)
; [exec]
; var error: Ref
(declare-const error@25@09 $Ref)
; [exec]
; var _cwl_156: Perm
(declare-const _cwl_156@26@09 $Perm)
; [exec]
; var _method_measures_156: Seq[Measure$]
(declare-const _method_measures_156@27@09 Seq<Measure$>)
; [exec]
; _method_measures_156 := Seq[Measure$]()
; [eval] Seq[Measure$]()
; [exec]
; inhale typeof(self) == NNAgent()
(declare-const $t@28@09 $Snap)
(assert (= $t@28@09 $Snap.unit))
; [eval] typeof(self) == NNAgent()
; [eval] typeof(self)
; [eval] NNAgent()
(assert (= (typeof<PyType> self@11@09) (as NNAgent<PyType>  PyType)))
...
; [exec]
; arg_13 := vehicle_3
; [eval] perm(_MaySet(arg, 34523215521221407446433640917057193469761)) > none
; [eval] perm(_MaySet(arg, 34523215521221407446433640917057193469761))
(set-option :timeout 10)
(push) ; 3
(assert (not (not
  (>
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 0 | W + (34523215521221407446433640917057193469761 == 10142612326481466590969612020568890212961870 ? W : Z) + (34523215521221407446433640917057193469761 == 664816698780718148718299689247834100430016695886 ? W : Z) + (34523215521221407446433640917057193469761 == 41311862561228097419861904740777028054620672394380115366859853390 ? W : Z) + (34523215521221407446433640917057193469761 == 526620359159434342146756288111005262 ? W : Z) + (34523215521221407446433640917057193469761 == 2261817219997544549373515003693597740981374542 ? W : Z) + (34523215521221407446433640917057193469761 == 2057743997646652586209098359459406 ? W : Z) + (34523215521221407446433640917057193469761 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (34523215521221407446433640917057193469761 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z | live]
; [else-branch: 0 | !(W + (34523215521221407446433640917057193469761 == 10142612326481466590969612020568890212961870 ? W : Z) + (34523215521221407446433640917057193469761 == 664816698780718148718299689247834100430016695886 ? W : Z) + (34523215521221407446433640917057193469761 == 41311862561228097419861904740777028054620672394380115366859853390 ? W : Z) + (34523215521221407446433640917057193469761 == 526620359159434342146756288111005262 ? W : Z) + (34523215521221407446433640917057193469761 == 2261817219997544549373515003693597740981374542 ? W : Z) + (34523215521221407446433640917057193469761 == 2057743997646652586209098359459406 ? W : Z) + (34523215521221407446433640917057193469761 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (34523215521221407446433640917057193469761 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z) | dead]
(push) ; 3
; [then-branch: 0 | W + (34523215521221407446433640917057193469761 == 10142612326481466590969612020568890212961870 ? W : Z) + (34523215521221407446433640917057193469761 == 664816698780718148718299689247834100430016695886 ? W : Z) + (34523215521221407446433640917057193469761 == 41311862561228097419861904740777028054620672394380115366859853390 ? W : Z)
== 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z) | dead]
(push) ; 5
; [then-branch: 2 | (2261817219997544549373515003693597740981374542 == 10142612326481466590969612020568890212961870 ? W : Z) + (2261817219997544549373515003693597740981374542 == 664816698780718148718299689247834100430016695886 ? W : Z) + (2261817219997544549373515003693597740981374542 == 41311862561228097419861904740777028054620672394380115366859853390 ? W : Z) + W + (2261817219997544549373515003693597740981374542 == 2057743997646652586209098359459406 ? W : Z) + (2261817219997544549373515003693597740981374542 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (2261817219997544549373515003693597740981374542 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z]
(assert (>
  (+
  ...
  $Perm.No))
; [exec]
; exhale acc(_MaySet(self_8, 2261817219997544549373515003693597740981374542), write)
; [exec]
; inhale acc(self_8.NNAgent_ego_vehicle, write)
(declare-const $t@32@09 $Ref)
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
; [exec]
; self_8.NNAgent_ego_vehicle := vehicle_3
; [eval] perm(_MaySet(self_8, 41311862561228097419861904740777028054620672394380115366859853390)) > none
; [eval] perm(_MaySet(self_8, 41311862561228097419861904740777028054620672394380115366859853390))
(set-option :timeout 10)
(push) ; 6
(assert (not (not
  (>
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 3 | (41311862561228097419861904740777028054620672394380115366859853390 == 10142612326481466590969612020568890212961870 ? W : Z) + (41311862561228097419861904740777028054620672394380115366859853390 == 664816698780718148718299689247834100430016695886 ? W : Z) + W + (41311862561228097419861904740777028054620672394380115366859853390 == 2057743997646652586209098359459406 ? W : Z) + (41311862561228097419861904740777028054620672394380115366859853390 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (41311862561228097419861904740777028054620672394380115366859853390 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z | live]
; [else-branch: 3 | !((41311862561228097419861904740777028054620672394380115366859853390 == 10142612326481466590969612020568890212961870 ? W : Z) + (41311862561228097419861904740777028054620672394380115366859853390 == 664816698780718148718299689247834100430016695886 ? W : Z) + W + (41311862561228097419861904740777028054620672394380115366859853390 == 2057743997646652586209098359459406 ? W : Z) + (41311862561228097419861904740777028054620672394380115366859853390 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (41311862561228097419861904740777028054620672394380115366859853390 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z) | dead]
(push) ; 6
; [then-branch: 3 | (41311862561228097419861904740777028054620672394380115366859853390 == 10142612326481466590969612020568890212961870 ? W : Z) + (41311862561228097419861904740777028054620672394380115366859853390 == 664816698780718148718299689247834100430016695886 ? W : Z) + W + (41311862561228097419861904740777028054620672394380115366859853390 == 2057743997646652586209098359459406 ? W : Z) + (41311862561228097419861904740777028054620672394380115366859853390 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (41311862561228097419861904740777028054620672394380115366859853390 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z]
(assert (>
  (+
  ...
  $Perm.No))
; [exec]
; exhale acc(_MaySet(self_8, 41311862561228097419861904740777028054620672394380115366859853390), write)
; [exec]
; inhale acc(self_8.NNAgent__blocking_threshold, write)
(declare-const $t@33@09 $Ref)
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
; [exec]
; self_8.NNAgent__blocking_threshold := __prim__int___box__(20)
; [eval] __prim__int___box__(20)
(push) ; 7
(pop) ; 7
; Joined path conditions
(declare-const NNAgent__blocking_threshold@34@09 $Ref)
(assert (= NNAgent__blocking_threshold@34@09 (__prim__int___box__ $Snap.unit 20)))
; [eval] perm(_MaySet(self_8, 2057743997646652586209098359459406)) > none
; [eval] perm(_MaySet(self_8, 2057743997646652586209098359459406))
(set-option :timeout 10)
(push) ; 7
(assert (not (not
  (>
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 4 | (2057743997646652586209098359459406 == 10142612326481466590969612020568890212961870 ? W : Z) + (2057743997646652586209098359459406 == 664816698780718148718299689247834100430016695886 ? W : Z) + W + (2057743997646652586209098359459406 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (2057743997646652586209098359459406 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z | live]
; [else-branch: 4 | !((2057743997646652586209098359459406 == 10142612326481466590969612020568890212961870 ? W : Z) + (2057743997646652586209098359459406 == 664816698780718148718299689247834100430016695886 ? W : Z) + W + (2057743997646652586209098359459406 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (2057743997646652586209098359459406 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z) | dead]
(push) ; 7
; [then-branch: 4 | (2057743997646652586209098359459406 == 10142612326481466590969612020568890212961870 ? W : Z) + (2057743997646652586209098359459406 == 664816698780718148718299689247834100430016695886 ? W : Z) + W + (2057743997646652586209098359459406 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (2057743997646652586209098359459406 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z]
(assert (>
  (+
  ...
  $Perm.No))
; [exec]
; exhale acc(_MaySet(self_8, 2057743997646652586209098359459406), write)
; [exec]
; inhale acc(self_8.NNAgent__state, write)
(declare-const $t@35@09 $Ref)
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
; [exec]
; self_8.NNAgent__state := str___create__(10, 336732150241531396505934)
; [eval] str___create__(10, 336732150241531396505934)
(push) ; 8
(pop) ; 8
; Joined path conditions
(declare-const NNAgent__state@36@09 $Ref)
(assert (= NNAgent__state@36@09 (str___create__ $Snap.unit 10 336732150241531396505934)))
; [eval] perm(_MaySet(self_8, 664816698780718148718299689247834100430016695886)) > none
; [eval] perm(_MaySet(self_8, 664816698780718148718299689247834100430016695886))
(set-option :timeout 10)
(push) ; 8
(assert (not (not
  (>
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 5 | (664816698780718148718299689247834100430016695886 == 10142612326481466590969612020568890212961870 ? W : Z) + W + (664816698780718148718299689247834100430016695886 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (664816698780718148718299689247834100430016695886 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z | live]
; [else-branch: 5 | !((664816698780718148718299689247834100430016695886 == 10142612326481466590969612020568890212961870 ? W : Z) + W + (664816698780718148718299689247834100430016695886 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (664816698780718148718299689247834100430016695886 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z) | dead]
(push) ; 8
; [then-branch: 5 | (664816698780718148718299689247834100430016695886 == 10142612326481466590969612020568890212961870 ? W : Z) + W + (664816698780718148718299689247834100430016695886 == 72278396927994961140698856492345702063570711301710 ? W : Z) + (664816698780718148718299689247834100430016695886 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z]
(assert (>
  (+
  ...
  $Perm.No))
; [exec]
; exhale acc(_MaySet(self_8, 664816698780718148718299689247834100430016695886), write)
; [exec]
; inhale acc(self_8.NNAgent_vehicle_list, write)
(declare-const $t@37@09 $Ref)
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
; [exec]
; self_8.NNAgent_vehicle_list := vehicle_list_1
; [eval] perm(_MaySet(self_8, 72278396927994961140698856492345702063570711301710)) > none
; [eval] perm(_MaySet(self_8, 72278396927994961140698856492345702063570711301710))
(set-option :timeout 10)
(push) ; 9
(assert (not (not
  (>
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 6 | (72278396927994961140698856492345702063570711301710 == 10142612326481466590969612020568890212961870 ? W : Z) + W + (72278396927994961140698856492345702063570711301710 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z | live]
; [else-branch: 6 | !((72278396927994961140698856492345702063570711301710 == 10142612326481466590969612020568890212961870 ? W : Z) + W + (72278396927994961140698856492345702063570711301710 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z) | dead]
(push) ; 9
; [then-branch: 6 | (72278396927994961140698856492345702063570711301710 == 10142612326481466590969612020568890212961870 ? W : Z) + W + (72278396927994961140698856492345702063570711301710 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z]
(assert (>
  (+
    (+
      (ite
  ...
  $Perm.No))
; [exec]
; exhale acc(_MaySet(self_8, 72278396927994961140698856492345702063570711301710), write)
; [exec]
; inhale acc(self_8.NNAgent_vehicle_list1, write)
(declare-const $t@38@09 $Ref)
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
; [exec]
; self_8.NNAgent_vehicle_list1 := vehicle_list_1
; [eval] perm(_MaySet(self_8, 10142612326481466590969612020568890212961870)) > none
; [eval] perm(_MaySet(self_8, 10142612326481466590969612020568890212961870))
(set-option :timeout 10)
(push) ; 10
(assert (not (not
  (>
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 7 | W + (10142612326481466590969612020568890212961870 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z | live]
; [else-branch: 7 | !(W + (10142612326481466590969612020568890212961870 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z) | dead]
(push) ; 10
; [then-branch: 7 | W + (10142612326481466590969612020568890212961870 == 177474133564370060510304510339217458269228635136257967959390828326350310990 ? W : Z) > Z]
(assert (>
  (+
    $Perm.Write
    (ite
  ...
  $Perm.No))
; [exec]
; exhale acc(_MaySet(self_8, 10142612326481466590969612020568890212961870), write)
; [exec]
; inhale acc(self_8.NNAgent_time_count, write)
(declare-const $t@39@09 $Ref)
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
; [exec]
; self_8.NNAgent_time_count := __prim__int___box__(0)
; [eval] __prim__int___box__(0)
(push) ; 11
(pop) ; 11
; Joined path conditions
(declare-const NNAgent_time_count@40@09 $Ref)
(assert (= NNAgent_time_count@40@09 (__prim__int___box__ $Snap.unit 0)))
; [eval] perm(_MaySet(self_8, 177474133564370060510304510339217458269228635136257967959390828326350310990)) > none
; [eval] perm(_MaySet(self_8, 177474133564370060510304510339217458269228635136257967959390828326350310990))
(set-option :timeout 10)
(push) ; 11
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 8 | W > Z | live]
; [else-branch: 8 | !(W > Z) | dead]
(push) ; 11
; [then-branch: 8 | W > Z]
(assert (> $Perm.Write $Perm.No))
; [exec]
; exhale acc(_MaySet(self_8, 177474133564370060510304510339217458269228635136257967959390828326350310990), write)
; [exec]
; inhale acc(self_8.NNAgent_vehicle_junction_hazard, write)
(declare-const $t@41@09 $Ref)
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
; [exec]
; self_8.NNAgent_vehicle_junction_hazard := __prim__bool___box__(false)
; [eval] __prim__bool___box__(false)
(push) ; 12
(pop) ; 12
; Joined path conditions
(declare-const NNAgent_vehicle_junction_hazard@42@09 $Ref)
(assert (= NNAgent_vehicle_junction_hazard@42@09 (__prim__bool___box__ $Snap.unit false)))
; [exec]
; label __end
; [eval] issubtype(typeof(self.NNAgent_vehicle), Vehicle())
; [eval] typeof(self.NNAgent_vehicle)
...
(push) ; 12
(assert (not (object___eq__ $Snap.unit vehicle@12@09 vehicle@12@09)))
(check-sat)
; unsat
(pop) ; 12
; 0.00s
; (get-info :all-statistics)
(assert (object___eq__ $Snap.unit vehicle@12@09 vehicle@12@09))
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: 9 | !(W > Z) | dead]
; [else-branch: 9 | W > Z | live]
(push) ; 11
; [else-branch: 9 | W > Z]
(assert (> $Perm.Write $Perm.No))
(pop) ; 11
...
; 0.00s
; (get-info :all-statistics)
; [then-branch: