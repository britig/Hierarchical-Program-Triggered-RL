...
; ------------------------------------------------------------
; ---------- NNAgent_check_functional_safety ----------
(declare-const _cthread_158@0@07 $Ref)
(declare-const _caller_measures_158@1@07 Seq<Measure$>)
(declare-const _residue_158@2@07 $Perm)
(declare-const self_1@3@07 $Ref)
(declare-const _current_wait_level_158@4@07 $Perm)
(declare-const _res@5@07 $Ref)
(declare-const _cthread_158@6@07 $Ref)
(declare-const _caller_measures_158@7@07 Seq<Measure$>)
(declare-const _residue_158@8@07 $Perm)
(declare-const self_1@9@07 $Ref)
(declare-const _current_wait_level_158@10@07 $Perm)
(declare-const _res@11@07 $Ref)
(push) ; 1
...
(assert (not (= _cthread_158@6@07 $Ref.null)))
(assert (=
  ($Snap.second $t@12@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@12@07))
    ($Snap.second ($Snap.second $t@12@07)))))
(assert (= ($Snap.first ($Snap.second $t@12@07)) $Snap.unit))
; [eval] issubtype(typeof(_cthread_158), Thread_0())
; [eval] typeof(_cthread_158)
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_158@6@07) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second $t@12@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@12@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@12@07))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@12@07))) $Snap.unit))
; [eval] issubtype(typeof(self_1), NNAgent())
; [eval] typeof(self_1)
; [eval] NNAgent()
(assert (issubtype<Bool> (typeof<PyType> self_1@9@07) (as NNAgent<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@12@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@12@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@07)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@12@07))))
  $Snap.unit))
; [eval] self_1 != null
(assert (not (= self_1@9@07 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@07))))
  $Snap.unit))
...
(assert (= $t@13@07 ($Snap.combine ($Snap.first $t@13@07) ($Snap.second $t@13@07))))
(assert (= ($Snap.first $t@13@07) $Snap.unit))
; [eval] (forperm _r_22: Ref [_r_22.MustReleaseBounded] :: Level(_r_22) <= _current_wait_level_158)
(assert (=
  ($Snap.second $t@13@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@13@07))
    ($Snap.second ($Snap.second $t@13@07)))))
(assert (= ($Snap.first ($Snap.second $t@13@07)) $Snap.unit))
; [eval] (forperm _r_22: Ref [_r_22.MustReleaseUnbounded] :: Level(_r_22) <= _current_wait_level_158)
(assert (=
  ($Snap.second ($Snap.second $t@13@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@13@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@13@07))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@13@07))) $Snap.unit))
; [eval] _residue_158 <= _current_wait_level_158
(assert (<= _residue_158@8@07 _current_wait_level_158@10@07))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@13@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@13@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@07)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@13@07))))
  $Snap.unit))
...
; [eval] typeof(_res)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> _res@11@07) (as int<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@07))))
  $Snap.unit))
(pop) ; 2
...
; [exec]
; var _err: Ref
(declare-const _err@14@07 $Ref)
; [exec]
; var self_10: Ref
(declare-const self_10@15@07 $Ref)
; [exec]
; var _cwl_158: Perm
(declare-const _cwl_158@16@07 $Perm)
; [exec]
; var _method_measures_158: Seq[Measure$]
(declare-const _method_measures_158@17@07 Seq<Measure$>)
; [exec]
; _method_measures_158 := Seq[Measure$]()
; [eval] Seq[Measure$]()
; [exec]
; inhale typeof(self_1) == NNAgent()
(declare-const $t@18@07 $Snap)
(assert (= $t@18@07 $Snap.unit))
; [eval] typeof(self_1) == NNAgent()
; [eval] typeof(self_1)
; [eval] NNAgent()
(assert (= (typeof<PyType> self_1@9@07) (as NNAgent<PyType>  PyType)))
...
(declare-const _res@19@07 $Ref)
(assert (= _res@19@07 (__prim__int___box__ $Snap.unit 0)))
; [exec]
; label __end
; [eval] issubtype(typeof(_res), int())
; [eval] typeof(_res)
...
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> _res@19@07) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.02s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> _res@19@07) (as int<PyType>  PyType)))
...
(declare-const _cthread_163@20@07 $Ref)
(declare-const _caller_measures_163@21@07 Seq<Measure$>)
(declare-const _residue_163@22@07 $Perm)
(declare-const self_6@23@07 $Ref)
(declare-const _current_wait_level_163@24@07 $Perm)
(declare-const _res@25@07 $Ref)
(declare-const _cthread_163@26@07 $Ref)
(declare-const _caller_measures_163@27@07 Seq<Measure$>)
(declare-const _residue_163@28@07 $Perm)
(declare-const self_6@29@07 $Ref)
(declare-const _current_wait_level_163@30@07 $Perm)
(declare-const _res@31@07 $Ref)
(push) ; 1
(declare-const $t@32@07 $Snap)
(assert (= $t@32@07 ($Snap.combine ($Snap.first $t@32@07) ($Snap.second $t@32@07))))
(assert (= ($Snap.first $t@32@07) $Snap.unit))
; [eval] _cthread_163 != null
(assert (not (= _cthread_163@26@07 $Ref.null)))
(assert (=
  ($Snap.second $t@32@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@32@07))
    ($Snap.second ($Snap.second $t@32@07)))))
(assert (= ($Snap.first ($Snap.second $t@32@07)) $Snap.unit))
; [eval] issubtype(typeof(_cthread_163), Thread_0())
; [eval] typeof(_cthread_163)
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_163@26@07) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second $t@32@07))
  ($Snap.combine
...
; [eval] typeof(self_6)
; [eval] Agent()
(assert (issubtype<Bool> (typeof<PyType> self_6@29@07) (as Agent<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@32@07)))
  ($Snap.combine
...
(assert (=
  ...
  $Snap.unit))
; [eval] self_6 != null
(assert (not (= self_6@29@07 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@32@07))))
  $Snap.unit))
; State saturation: after contract
...
(assert (=
  ($Snap.second ($Snap.second $t@33@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@33@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@33@07))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@33@07))) $Snap.unit))
; [eval] _residue_163 <= _current_wait_level_163
(assert (<= _residue_163@28@07 _current_wait_level_163@30@07))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@33@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@33@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@33@07)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@33@07))))
  $Snap.unit))
; [eval] issubtype(typeof(_res), int())
; [eval] typeof(_res)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> _res@31@07) (as int<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@33@07))))
  $Snap.unit))
(pop) ; 2
...
; [exec]
; var _err: Ref
(declare-const _err@34@07 $Ref)
; [exec]
; var self_14: Ref
(declare-const self_14@35@07 $Ref)
; [exec]
; var _cwl_163: Perm
(declare-const _cwl_163@36@07 $Perm)
; [exec]
; var _method_measures_163: Seq[Measure$]
(declare-const _method_measures_163@37@07 Seq<Measure$>)
; [exec]
; _method_measures_163 := Seq[Measure$]()
; [eval] Seq[Measure$]()
; [exec]
; inhale typeof(self_6) == Agent()
(declare-const $t@38@07 $Snap)
(assert (= $t@38@07 $Snap.unit))
; [eval] typeof(self_6) == Agent()
; [eval] typeof(self_6)
; [eval] Agent()
(assert (= (typeof<PyType> self_6@29@07) (as Agent<PyType>  PyType)))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(pop) ; 3
; Joined path conditions
(declare-const _res@39@07 $Ref)
(assert (= _res@39@07 (__prim__int___box__ $Snap.unit 0)))
; [exec]
; label __end
; [eval] issubtype(typeof(_res), int())
; [eval] typeof(_res)
...
(set-option :timeout 0)
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> _res@39@07) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> _res@39@07) (as int<PyType>  PyType)))
...
(pop) ; 1
; ---------- Iterator___del__ ----------
(declare-const _cthread_150@40@07 $Ref)
(declare-const _caller_measures_150@41@07 Seq<Measure$>)
(declare-const _residue_150@42@07 $Perm)
(declare-const self@43@07 $Ref)
(declare-const _current_wait_level_150@44@07 $Perm)
(declare-const _cthread_150@45@07 $Ref)
(declare-const _caller_measures_150@46@07 Seq<Measure$>)
(declare-const _residue_150@47@07 $Perm)
(declare-const self@48@07 $Ref)
(declare-const _current_wait_level_150@49@07 $Perm)
(push) ; 1
(declare-const $t@50@07 $Snap)
(assert (= $t@50@07 ($Snap.combine ($Snap.first $t@50@07) ($Snap.second $t@50@07))))
(assert (= ($Snap.first $t@50@07) $Snap.unit))
; [eval] _cthread_150 != null
(assert (not (= _cthread_150@45@07 $Ref.null)))
(assert (=
  ($Snap.second $t@50@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@50@07))
    ($Snap.second ($Snap.second $t@50@07)))))
(assert (= ($Snap.first ($Snap.second $t@50@07)) $Snap.unit))
; [eval] Measure$check(_caller_measures_150, _cthread_150, 1)
(push) ; 2
(pop) ; 2
; Joined path conditions
(assert (Measure$check $Snap.unit _caller_measures_150@46@07 _cthread_150@45@07 1))
(assert (=
  ($Snap.second ($Snap.second $t@50@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@50@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@50@07))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@50@07))) $Snap.unit))
; [eval] issubtype(typeof(_cthread_150), Thread_0())
; [eval] typeof(_cthread_150)
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_150@45@07) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@50@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@50@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@50@07)))))))
(push) ; 2
(assert (not (not (= 20 0))))
(check-sat)
; unsat
...
; 0.00s
; (get-info :all-statistics)
(assert (not (= self@48@07 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@50@07))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@50@07)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@50@07))))))))
(push) ; 2
(assert (not (not (= 20 0))))
(check-sat)
; unsat
...
(assert (= $t@51@07 ($Snap.combine ($Snap.first $t@51@07) ($Snap.second $t@51@07))))
(assert (= ($Snap.first $t@51@07) $Snap.unit))
; [eval] (forperm _r_54: Ref [_r_54.MustReleaseBounded] :: Level(_r_54) <= _current_wait_level_150)
(assert (=
  ($Snap.second $t@51@07)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@51@07))
    ($Snap.second ($Snap.second $t@51@07)))))
(assert (= ($Snap.first ($Snap.second $t@51@07)) $Snap.unit))
; [eval] (forperm _r_54: Ref [_r_54.MustReleaseUnbounded] :: Level(_r_54) <= _current_wait_level_150)
(assert (=
  ($Snap.second ($Snap.second $t@51@07))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@51@07)))
    ($Snap.second ($Snap.second ($Snap.second $t@51@07))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@51@07))) $Snap.unit))
; [eval] _residue_150 <= _current_wait_level_150
(assert (<= _residue_150@47@07 _current_wait_level_150@49@07))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@51@07)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))))
(set-option :timeout 0)
(push) ; 3
(assert (not (not (= 20 0))))
(check-sat)
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07))))))))
...
(push) ; 3
(assert (not (not
  (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (list<PyType> (list_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0))))))
(check-sat)
; unknown
(pop) ; 3
; 0.02s
; (get-info :all-statistics)
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (list<PyType> (list_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0)))))
(check-sat)
; unknown
(pop) ; 3
; 0.02s
; (get-info :all-statistics)
; [then-branch: 0 | issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), list[PyType](list_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0))) | live]
; [else-branch: 0 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), list[PyType](list_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0)))) | live]
(push) ; 3
; [then-branch: 0 | issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), list[PyType](list_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0)))]
(assert (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (list<PyType> (list_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0))))
(set-option :timeout 0)
(push) ; 4
(assert (not (not (= 20 0))))
(check-sat)
...
(assert (not
  (=
    ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))
    $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))))))
...
(push) ; 4
(assert (not (not
  (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (dict<PyType> (dict_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0) (dict_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 1))))))
(check-sat)
; unsat
(pop) ; 4
; 0.03s
; (get-info :all-statistics)
; [then-branch: 1 | issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), dict[PyType](dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0), dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 1))) | dead]
; [else-branch: 1 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), dict[PyType](dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0), dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 1)))) | live]
(push) ; 4
; [else-branch: 1 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), dict[PyType](dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0), dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 1))))]
(assert (not
  (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (dict<PyType> (dict_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0) (dict_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 1)))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07))))))
...
(push) ; 5
(assert (not (not
  (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (set<PyType> (set_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0))))))
(check-sat)
; unsat
(pop) ; 5
; 0.02s
; (get-info :all-statistics)
; [then-branch: 2 | issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0))) | dead]
; [else-branch: 2 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0)))) | live]
(push) ; 5
; [else-branch: 2 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0))))]
(assert (not
  (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (set<PyType> (set_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0)))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07))))))
...
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), list[PyType](list_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0))))]
(assert (not
  (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (list<PyType> (list_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0)))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))
...
; 0.02s
; (get-info :all-statistics)
; [then-branch: 3 | issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), dict[PyType](dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0), dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 1))) | live]
; [else-branch: 3 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), dict[PyType](dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0), dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 1)))) | live]
(push) ; 4
; [then-branch: 3 | issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), dict[PyType](dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0), dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 1)))]
(assert (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (dict<PyType> (dict_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0) (dict_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 1))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07))))))
  ($Snap.combine
    ($Snap.first ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))))
    ($Snap.second ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07))))))))))
(set-option :timeout 0)
(push) ; 5
(assert (not (not (= 20 0))))
(check-sat)
...
; (get-info :all-statistics)
(push) ; 5
(assert (not (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (set<PyType> (set_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0)))))
(check-sat)
; unknown
(pop) ; 5
; 0.03s
; (get-info :all-statistics)
; [then-branch: 4 | issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0))) | live]
; [else-branch: 4 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0)))) | live]
(push) ; 5
; [then-branch: 4 | issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0)))]
(assert (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (set<PyType> (set_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0))))
(set-option :timeout 0)
(push) ; 6
(assert (not (not (= 20 0))))
(check-sat)
...
(pop) ; 5
(push) ; 5
; [else-branch: 4 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0))))]
(assert (not
  (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (set<PyType> (set_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0)))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07))))))
...
(pop) ; 4
(push) ; 4
; [else-branch: 3 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), dict[PyType](dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0), dict_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 1))))]
(assert (not
  (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (dict<PyType> (dict_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0) (dict_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 1)))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07))))))
...
; 0.03s
; (get-info :all-statistics)
; [then-branch: 5 | issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0))) | live]
; [else-branch: 5 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0)))) | live]
(push) ; 5
; [then-branch: 5 | issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0)))]
(assert (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (set<PyType> (set_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0))))
(set-option :timeout 0)
(push) ; 6
(assert (not (not (= 20 0))))
...
(pop) ; 5
(push) ; 5
; [else-branch: 5 | !(issubtype[Bool](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), set[PyType](set_arg[PyType](typeof[PyType](First:(Second:(Second:(Second:($t@51@07))))), 0))))]
(assert (not
  (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) (set<PyType> (set_arg<PyType> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@51@07)))))) 0)))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@51@07))))))
...
; [exec]
; var _cwl_150: Perm
(declare-const _cwl_150@52@07 $Perm)
; [exec]
; inhale false
(pop) ; 2
(pop) ; 1
