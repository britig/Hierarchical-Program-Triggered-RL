...
; ------------------------------------------------------------
; ---------- Agent___init__ ----------
(declare-const _cthread_160@0@03 $Ref)
(declare-const _caller_measures_160@1@03 Seq<Measure$>)
(declare-const _residue_160@2@03 $Perm)
(declare-const self_3@3@03 $Ref)
(declare-const vehicle_0@4@03 $Ref)
(declare-const _current_wait_level_160@5@03 $Perm)
(declare-const _cthread_160@6@03 $Ref)
(declare-const _caller_measures_160@7@03 Seq<Measure$>)
(declare-const _residue_160@8@03 $Perm)
(declare-const self_3@9@03 $Ref)
(declare-const vehicle_0@10@03 $Ref)
(declare-const _current_wait_level_160@11@03 $Perm)
(push) ; 1
...
(assert (not (= _cthread_160@6@03 $Ref.null)))
(assert (=
  ($Snap.second $t@12@03)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@12@03))
    ($Snap.second ($Snap.second $t@12@03)))))
(assert (= ($Snap.first ($Snap.second $t@12@03)) $Snap.unit))
; [eval] issubtype(typeof(_cthread_160), Thread_0())
; [eval] typeof(_cthread_160)
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_160@6@03) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second $t@12@03))
  ($Snap.combine
...
; [eval] self_3 != null
(assert (not (= self_3@9@03 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@12@03)))
  ($Snap.combine
...
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@03)))))
  $Snap.unit))
; [eval] issubtype(typeof(self_3), Agent())
; [eval] typeof(self_3)
; [eval] Agent()
(assert (issubtype<Bool> (typeof<PyType> self_3@9@03) (as Agent<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@03)))))
  ($Snap.combine
...
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@03))))))
  $Snap.unit))
; [eval] issubtype(typeof(vehicle_0), Vehicle())
; [eval] typeof(vehicle_0)
; [eval] Vehicle()
(assert (issubtype<Bool> (typeof<PyType> vehicle_0@10@03) (as Vehicle<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@03))))))
  ($Snap.combine
...
; [eval] (forperm _r_34: Ref [_r_34.MustReleaseBounded] :: Level(_r_34) <= _current_wait_level_160)
(assert (=
  ($Snap.second $t@13@03)
  ($Snap.combine
...
; [eval] (forperm _r_34: Ref [_r_34.MustReleaseUnbounded] :: Level(_r_34) <= _current_wait_level_160)
(assert (=
  ($Snap.second ($Snap.second $t@13@03))
  ($Snap.combine
...
(assert (<= _residue_160@8@03 _current_wait_level_160@11@03))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@13@03)))
  ($Snap.combine
...
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@03)))))
  $Snap.unit))
; [eval] issubtype(typeof(self_3.Agent_light_state), bool())
; [eval] typeof(self_3.Agent_light_state)
; [eval] bool()
(assert (issubtype<Bool> (typeof<PyType> ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@13@03)))))) (as bool<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@03)))))
  $Snap.unit))
(pop) ; 2
...
; [exec]
; var _err: Ref
(declare-const _err@14@03 $Ref)
; [exec]
; var self_11: Ref
(declare-const self_11@15@03 $Ref)
; [exec]
; var vehicle_4: Ref
(declare-const vehicle_4@16@03 $Ref)
; [exec]
; var _cwl_160: Perm
(declare-const _cwl_160@17@03 $Perm)
; [exec]
; var _method_measures_160: Seq[Measure$]
(declare-const _method_measures_160@18@03 Seq<Measure$>)
; [exec]
; _method_measures_160 := Seq[Measure$]()
; [eval] Seq[Measure$]()
; [exec]
; inhale typeof(self_3) == Agent()
(declare-const $t@19@03 $Snap)
(assert (= $t@19@03 $Snap.unit))
; [eval] typeof(self_3) == Agent()
; [eval] typeof(self_3)
; [eval] Agent()
(assert (= (typeof<PyType> self_3@9@03) (as Agent<PyType>  PyType)))
...
; [exec]
; vehicle_4 := vehicle_0
; [eval] perm(_MaySet(self_11, 34523215521221407446433640917057193469761)) > none
; [eval] perm(_MaySet(self_11, 34523215521221407446433640917057193469761))
...
; 0.01s
; (get-info :all-statistics)
; [then-branch: 0 | W > Z | live]
; [else-branch: 0 | !(W > Z) | dead]
(push) ; 3
; [then-branch: 0 | W > Z]
(assert (> $Perm.Write $Perm.No))
; [exec]
; exhale acc(_MaySet(self_11, 34523215521221407446433640917057193469761), write)
; [exec]
; inhale acc(self_11.Agent_light_state, write)
...
; unknown
; [exec]
; self_11.Agent_light_state := __prim__bool___box__(false)
; [eval] __prim__bool___box__(false)
(push) ; 4
(pop) ; 4
; Joined path conditions
(declare-const Agent_light_state@21@03 $Ref)
(assert (= Agent_light_state@21@03 (__prim__bool___box__ $Snap.unit false)))
; [exec]
; label __end
; [eval] issubtype(typeof(self_3.Agent_light_state), bool())
; [eval] typeof(self_3.Agent_light_state)
...
(push) ; 4
(assert (not (issubtype<Bool> (typeof<PyType> Agent_light_state@21@03) (as bool<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> Agent_light_state@21@03) (as bool<PyType>  PyType)))
; [eval] (forperm _r_35: Ref [MustInvokeBounded(_r_35)] :: false)
; [eval] (forperm _r_35: Ref [MustInvokeUnbounded(_r_35)] :: false)
; [eval] (forperm _r_35: Ref [_r_35.MustReleaseBounded] :: false)
; [eval] (forperm _r_35: Ref [_r_35.MustReleaseUnbounded] :: false)
(pop) ; 3
; [eval] !(perm(_MaySet(self_11, 34523215521221407446433640917057193469761)) > none)
; [eval] perm(_MaySet(self_11, 34523215521221407446433640917057193469761)) > none
; [eval] perm(_MaySet(self_11, 34523215521221407446433640917057193469761))
...
; 0.01s
; (get-info :all-statistics)
; [then-branch: 1 | !(W > Z) | dead]
; [else-branch: 1 | W > Z | live]
(push) ; 3
; [else-branch: 1 | W > Z]
(assert (> $Perm.Write $Perm.No))
(pop) ; 3
...
(pop) ; 1
; ---------- list_append ----------
(declare-const _cthread_9@22@03 $Ref)
(declare-const _caller_measures_9@23@03 Seq<Measure$>)
(declare-const _residue_9@24@03 $Perm)
(declare-const self@25@03 $Ref)
(declare-const item@26@03 $Ref)
(declare-const _current_wait_level_9@27@03 $Perm)
(declare-const _cthread_9@28@03 $Ref)
(declare-const _caller_measures_9@29@03 Seq<Measure$>)
(declare-const _residue_9@30@03 $Perm)
(declare-const self@31@03 $Ref)
(declare-const item@32@03 $Ref)
(declare-const _current_wait_level_9@33@03 $Perm)
(push) ; 1
...
(assert (not (= _cthread_9@28@03 $Ref.null)))
(assert (=
  ($Snap.second $t@34@03)
  ($Snap.combine
...
(pop) ; 2
; Joined path conditions
(assert (Measure$check $Snap.unit _caller_measures_9@29@03 _cthread_9@28@03 1))
(assert (=
  ($Snap.second ($Snap.second $t@34@03))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@34@03)))
    ($Snap.second ($Snap.second ($Snap.second $t@34@03))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@34@03))) $Snap.unit))
; [eval] issubtype(typeof(_cthread_9), Thread_0())
; [eval] typeof(_cthread_9)
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_9@28@03) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@34@03)))
  ($Snap.combine
...
; [eval] typeof(self)
(assert (issubtype<Bool> (typeof<PyType> self@31@03) (list<PyType> (list_arg<PyType> (typeof<PyType> self@31@03) 0))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@34@03))))
  ($Snap.combine
...
(assert (not (= self@31@03 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@34@03)))))
  ($Snap.combine
...
; [eval] list_arg(typeof(self), 0)
; [eval] typeof(self)
(assert (issubtype<Bool> (typeof<PyType> item@32@03) (list_arg<PyType> (typeof<PyType> self@31@03) 0)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@34@03))))))
  $Snap.unit))
; State saturation: after contract
...
(assert (= ($Snap.first $t@35@03) $Snap.unit))
...
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@35@03))) $Snap.unit))
; [eval] _residue_9 <= _current_wait_level_9
(assert (<= _residue_9@30@03 _current_wait_level_9@33@03))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@35@03)))
  ($Snap.combine
...
; [eval] Seq(item)
(assert (= (Seq_length (Seq_singleton item@32@03)) 1))
(assert (Seq_equal
  ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@35@03)))))
  (Seq_append
    ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@34@03))))))
    (Seq_singleton item@32@03))))
(pop) ; 2
(push) ; 2
; [exec]
; var _cwl_9: Perm
(declare-const _cwl_9@36@03 $Perm)
; [exec]
; inhale false
(pop) ; 2
(pop) ; 1
; ---------- set___init__ ----------
(declare-const _cthread_21@37@03 $Ref)
(declare-const _caller_measures_21@38@03 Seq<Measure$>)
(declare-const _residue_21@39@03 $Perm)
(declare-const _current_wait_level_21@40@03 $Perm)
(declare-const res@41@03 $Ref)
(declare-const _cthread_21@42@03 $Ref)
(declare-const _caller_measures_21@43@03 Seq<Measure$>)
(declare-const _residue_21@44@03 $Perm)
(declare-const _current_wait_level_21@45@03 $Perm)
(declare-const res@46@03 $Ref)
(push) ; 1
(declare-const $t@47@03 $Snap)
(assert (= $t@47@03 ($Snap.combine ($Snap.first $t@47@03) ($Snap.second $t@47@03))))
(assert (= ($Snap.first $t@47@03) $Snap.unit))
; [eval] _cthread_21 != null
(assert (not (= _cthread_21@42@03 $Ref.null)))
(assert (=
  ($Snap.second $t@47@03)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@47@03))
    ($Snap.second ($Snap.second $t@47@03)))))
(assert (= ($Snap.first ($Snap.second $t@47@03)) $Snap.unit))
; [eval] Measure$check(_caller_measures_21, _cthread_21, 1)
(push) ; 2
(pop) ; 2
; Joined path conditions
(assert (Measure$check $Snap.unit _caller_measures_21@43@03 _cthread_21@42@03 1))
(assert (=
  ($Snap.second ($Snap.second $t@47@03))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@47@03)))
    ($Snap.second ($Snap.second ($Snap.second $t@47@03))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@47@03))) $Snap.unit))
; [eval] issubtype(typeof(_cthread_21), Thread_0())
; [eval] typeof(_cthread_21)
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_21@42@03) (as Thread_0<PyType>  PyType)))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@47@03))) $Snap.unit))
; State saturation: after contract
(check-sat)
; unknown
(push) ; 2
(declare-const $t@48@03 $Snap)
(assert (= $t@48@03 ($Snap.combine ($Snap.first $t@48@03) ($Snap.second $t@48@03))))
(assert (= ($Snap.first $t@48@03) $Snap.unit))
; [eval] (forperm _r_64: Ref [_r_64.MustReleaseBounded] :: Level(_r_64) <= _current_wait_level_21)
(assert (=
  ($Snap.second $t@48@03)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@48@03))
    ($Snap.second ($Snap.second $t@48@03)))))
(assert (= ($Snap.first ($Snap.second $t@48@03)) $Snap.unit))
; [eval] (forperm _r_64: Ref [_r_64.MustReleaseUnbounded] :: Level(_r_64) <= _current_wait_level_21)
(assert (=
  ($Snap.second ($Snap.second $t@48@03))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@48@03)))
    ($Snap.second ($Snap.second ($Snap.second $t@48@03))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@48@03))) $Snap.unit))
; [eval] _residue_21 <= _current_wait_level_21
(assert (<= _residue_21@44@03 _current_wait_level_21@45@03))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@48@03)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@48@03))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@03)))))))
(assert (not (= res@46@03 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@03))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@03)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@03))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@03)))))
  $Snap.unit))
; [eval] res.set_acc == Set[Ref]()
; [eval] Set[Ref]()
(assert (Set_equal ($SortWrappers.$SnapToSet<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@48@03))))) (as Set_empty  Set<$Ref>)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@03)))))
  $Snap.unit))
...
; [eval] typeof(res)
(assert (=
  (typeof<PyType> res@46@03)
  (set<PyType> (set_arg<PyType> (typeof<PyType> res@46@03) 0))))
(pop) ; 2
(push) ; 2
; [exec]
; var _cwl_21: Perm
(declare-const _cwl_21@49@03 $Perm)
; [exec]
; inhale false
(pop) ; 2
(pop) ; 1
