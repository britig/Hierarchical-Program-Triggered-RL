...
; ------------------------------------------------------------
; ---------- NNAgent_execute_lane_change_inherit_check ----------
(declare-const _cthread_162@0@05 $Ref)
(declare-const _caller_measures_162@1@05 Seq<Measure$>)
(declare-const _residue_162@2@05 $Perm)
(declare-const self_5@3@05 $Ref)
(declare-const _current_wait_level_162@4@05 $Perm)
(declare-const _res@5@05 $Ref)
(declare-const _cthread_162@6@05 $Ref)
(declare-const _caller_measures_162@7@05 Seq<Measure$>)
(declare-const _residue_162@8@05 $Perm)
(declare-const self_5@9@05 $Ref)
(declare-const _current_wait_level_162@10@05 $Perm)
(declare-const _res@11@05 $Ref)
(push) ; 1
...
(assert (not (= _cthread_162@6@05 $Ref.null)))
(assert (=
  ($Snap.second $t@12@05)
  ($Snap.combine
...
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_162@6@05) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second $t@12@05))
  ($Snap.combine
...
; [eval] self_5 != null
(assert (not (= self_5@9@05 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@12@05)))
  ($Snap.combine
...
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@12@05))))
  $Snap.unit))
; [eval] typeof(self_5) == NNAgent()
; [eval] typeof(self_5)
; [eval] NNAgent()
(assert (= (typeof<PyType> self_5@9@05) (as NNAgent<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@05))))
  ($Snap.combine
...
; [eval] typeof(self_5)
; [eval] Agent()
(assert (issubtype<Bool> (typeof<PyType> self_5@9@05) (as Agent<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@12@05)))))
  ($Snap.combine
...
; [eval] (forperm _r_28: Ref [_r_28.MustReleaseBounded] :: Level(_r_28) <= _current_wait_level_162)
(assert (=
  ($Snap.second $t@13@05)
  ($Snap.combine
...
; [eval] (forperm _r_28: Ref [_r_28.MustReleaseUnbounded] :: Level(_r_28) <= _current_wait_level_162)
(assert (=
  ($Snap.second ($Snap.second $t@13@05))
  ($Snap.combine
...
(assert (<= _residue_162@8@05 _current_wait_level_162@10@05))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@13@05)))
  ($Snap.combine
...
; [eval] typeof(_res)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> _res@11@05) (as int<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@13@05))))
  $Snap.unit))
(pop) ; 2
...
; [exec]
; var _cwl_162: Perm
(declare-const _cwl_162@14@05 $Perm)
; [exec]
; var _method_measures_162: Seq[Measure$]
(declare-const _method_measures_162@15@05 Seq<Measure$>)
; [exec]
; _method_measures_162 := Seq[Measure$]()
; [eval] Seq[Measure$]()
; [exec]
; _res := __prim__int___box__(100)
; [eval] __prim__int___box__(100)
(push) ; 3
(pop) ; 3
; Joined path conditions
(declare-const _res@16@05 $Ref)
(assert (= _res@16@05 (__prim__int___box__ $Snap.unit 100)))
; [exec]
; label __end_2
; [eval] issubtype(typeof(_res), int())
; [eval] typeof(_res)
...
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> _res@16@05) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> _res@16@05) (as int<PyType>  PyType)))
; [eval] (forperm _r_29: Ref [MustInvokeBounded(_r_29)] :: false)
; [eval] (forperm _r_29: Ref [MustInvokeUnbounded(_r_29)] :: false)
; [eval] (forperm _r_29: Ref [_r_29.MustReleaseBounded] :: false)
; [eval] (forperm _r_29: Ref [_r_29.MustReleaseUnbounded] :: false)
(pop) ; 2
(pop) ; 1
; ---------- Agent_execute_lane_change ----------
(declare-const _cthread_162@17@05 $Ref)
(declare-const _caller_measures_162@18@05 Seq<Measure$>)
(declare-const _residue_162@19@05 $Perm)
(declare-const self_5@20@05 $Ref)
(declare-const _current_wait_level_162@21@05 $Perm)
(declare-const _res@22@05 $Ref)
(declare-const _cthread_162@23@05 $Ref)
(declare-const _caller_measures_162@24@05 Seq<Measure$>)
(declare-const _residue_162@25@05 $Perm)
(declare-const self_5@26@05 $Ref)
(declare-const _current_wait_level_162@27@05 $Perm)
(declare-const _res@28@05 $Ref)
(push) ; 1
...
; [eval] _cthread_162 != null
(assert (not (= _cthread_162@23@05 $Ref.null)))
(assert (=
  ($Snap.second $t@29@05)
  ($Snap.combine
...
; [eval] typeof(_cthread_162)
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_162@23@05) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second $t@29@05))
  ($Snap.combine
...
; [eval] typeof(self_5)
; [eval] Agent()
(assert (issubtype<Bool> (typeof<PyType> self_5@26@05) (as Agent<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@29@05)))
  ($Snap.combine
...
(assert (=
  ...
  $Snap.unit))
; [eval] self_5 != null
(assert (not (= self_5@26@05 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@29@05))))
  $Snap.unit))
; State saturation: after contract
...
; unknown
(push) ; 2
(declare-const $t@30@05 $Snap)
(assert (= $t@30@05 ($Snap.combine ($Snap.first $t@30@05) ($Snap.second $t@30@05))))
(assert (= ($Snap.first $t@30@05) $Snap.unit))
; [eval] (forperm _r_40: Ref [_r_40.MustReleaseBounded] :: Level(_r_40) <= _current_wait_level_162)
(assert (=
  ($Snap.second $t@30@05)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@30@05))
    ($Snap.second ($Snap.second $t@30@05)))))
(assert (= ($Snap.first ($Snap.second $t@30@05)) $Snap.unit))
; [eval] (forperm _r_40: Ref [_r_40.MustReleaseUnbounded] :: Level(_r_40) <= _current_wait_level_162)
(assert (=
  ($Snap.second ($Snap.second $t@30@05))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@30@05)))
    ($Snap.second ($Snap.second ($Snap.second $t@30@05))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@30@05))) $Snap.unit))
; [eval] _residue_162 <= _current_wait_level_162
(assert (<= _residue_162@25@05 _current_wait_level_162@27@05))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@30@05)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@30@05))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@30@05)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@30@05))))
  $Snap.unit))
; [eval] issubtype(typeof(_res), int())
; [eval] typeof(_res)
; [eval] int()
(assert (issubtype<Bool> (typeof<PyType> _res@28@05) (as int<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@30@05))))
  $Snap.unit))
(pop) ; 2
...
; [exec]
; var _err: Ref
(declare-const _err@31@05 $Ref)
; [exec]
; var self_13: Ref
(declare-const self_13@32@05 $Ref)
; [exec]
; var _cwl_162: Perm
(declare-const _cwl_162@33@05 $Perm)
; [exec]
; var _method_measures_162: Seq[Measure$]
(declare-const _method_measures_162@34@05 Seq<Measure$>)
; [exec]
; _method_measures_162 := Seq[Measure$]()
; [eval] Seq[Measure$]()
; [exec]
; inhale typeof(self_5) == Agent()
(declare-const $t@35@05 $Snap)
(assert (= $t@35@05 $Snap.unit))
; [eval] typeof(self_5) == Agent()
; [eval] typeof(self_5)
; [eval] Agent()
(assert (= (typeof<PyType> self_5@26@05) (as Agent<PyType>  PyType)))
...
(pop) ; 3
; Joined path conditions
(declare-const _res@36@05 $Ref)
(assert (= _res@36@05 (__prim__int___box__ $Snap.unit 100)))
; [exec]
; label __end
; [eval] issubtype(typeof(_res), int())
; [eval] typeof(_res)
...
(set-option :timeout 0)
(push) ; 3
(assert (not (issubtype<Bool> (typeof<PyType> _res@36@05) (as int<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> _res@36@05) (as int<PyType>  PyType)))
...
(pop) ; 1
; ---------- list___init__ ----------
(declare-const _cthread_8@37@05 $Ref)
(declare-const _caller_measures_8@38@05 Seq<Measure$>)
(declare-const _residue_8@39@05 $Perm)
(declare-const _current_wait_level_8@40@05 $Perm)
(declare-const res@41@05 $Ref)
(declare-const _cthread_8@42@05 $Ref)
(declare-const _caller_measures_8@43@05 Seq<Measure$>)
(declare-const _residue_8@44@05 $Perm)
(declare-const _current_wait_level_8@45@05 $Perm)
(declare-const res@46@05 $Ref)
(push) ; 1
(declare-const $t@47@05 $Snap)
(assert (= $t@47@05 ($Snap.combine ($Snap.first $t@47@05) ($Snap.second $t@47@05))))
(assert (= ($Snap.first $t@47@05) $Snap.unit))
; [eval] _cthread_8 != null
(assert (not (= _cthread_8@42@05 $Ref.null)))
(assert (=
  ($Snap.second $t@47@05)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@47@05))
    ($Snap.second ($Snap.second $t@47@05)))))
(assert (= ($Snap.first ($Snap.second $t@47@05)) $Snap.unit))
; [eval] Measure$check(_caller_measures_8, _cthread_8, 1)
(push) ; 2
(pop) ; 2
; Joined path conditions
(assert (Measure$check $Snap.unit _caller_measures_8@43@05 _cthread_8@42@05 1))
(assert (=
  ($Snap.second ($Snap.second $t@47@05))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@47@05)))
    ($Snap.second ($Snap.second ($Snap.second $t@47@05))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@47@05))) $Snap.unit))
; [eval] issubtype(typeof(_cthread_8), Thread_0())
; [eval] typeof(_cthread_8)
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_8@42@05) (as Thread_0<PyType>  PyType)))
(assert (= ($Snap.second ($Snap.second ($Snap.second $t@47@05))) $Snap.unit))
; State saturation: after contract
(set-option :timeout 50)
(check-sat)
; unknown
(push) ; 2
(declare-const $t@48@05 $Snap)
(assert (= $t@48@05 ($Snap.combine ($Snap.first $t@48@05) ($Snap.second $t@48@05))))
(assert (= ($Snap.first $t@48@05) $Snap.unit))
; [eval] (forperm _r_56: Ref [_r_56.MustReleaseBounded] :: Level(_r_56) <= _current_wait_level_8)
(assert (=
  ($Snap.second $t@48@05)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@48@05))
    ($Snap.second ($Snap.second $t@48@05)))))
(assert (= ($Snap.first ($Snap.second $t@48@05)) $Snap.unit))
; [eval] (forperm _r_56: Ref [_r_56.MustReleaseUnbounded] :: Level(_r_56) <= _current_wait_level_8)
(assert (=
  ($Snap.second ($Snap.second $t@48@05))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@48@05)))
    ($Snap.second ($Snap.second ($Snap.second $t@48@05))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@48@05))) $Snap.unit))
; [eval] _residue_8 <= _current_wait_level_8
(assert (<= _residue_8@44@05 _current_wait_level_8@45@05))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@48@05)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@48@05))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@05)))))))
(assert (not (= res@46@05 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@05))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@05)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@05))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@05)))))
  $Snap.unit))
...
; [eval] Seq[Ref]()
(assert (Seq_equal
  ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@48@05)))))
  (as Seq_empty  Seq<$Ref>)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@05)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@05))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@05)))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@05))))))
  $Snap.unit))
...
; [eval] typeof(res)
(assert (=
  (typeof<PyType> res@46@05)
  (list<PyType> (list_arg<PyType> (typeof<PyType> res@46@05) 0))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@48@05))))))
  $Snap.unit))
; [eval] (Low(res): Bool)
(assert (Low<Bool> res@46@05))
(pop) ; 2
(push) ; 2
; [exec]
; var _cwl_8: Perm
(declare-const _cwl_8@49@05 $Perm)
; [exec]
; inhale false
(pop) ; 2
(pop) ; 1
; ---------- list___iter__ ----------
(declare-const _cthread_13@50@05 $Ref)
(declare-const _caller_measures_13@51@05 Seq<Measure$>)
(declare-const _residue_13@52@05 $Perm)
(declare-const self@53@05 $Ref)
(declare-const _current_wait_level_13@54@05 $Perm)
(declare-const _res@55@05 $Ref)
(declare-const _cthread_13@56@05 $Ref)
(declare-const _caller_measures_13@57@05 Seq<Measure$>)
(declare-const _residue_13@58@05 $Perm)
(declare-const self@59@05 $Ref)
(declare-const _current_wait_level_13@60@05 $Perm)
(declare-const _res@61@05 $Ref)
(push) ; 1
(declare-const $t@62@05 $Snap)
(assert (= $t@62@05 ($Snap.combine ($Snap.first $t@62@05) ($Snap.second $t@62@05))))
(assert (= ($Snap.first $t@62@05) $Snap.unit))
; [eval] _cthread_13 != null
(assert (not (= _cthread_13@56@05 $Ref.null)))
(assert (=
  ($Snap.second $t@62@05)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@62@05))
    ($Snap.second ($Snap.second $t@62@05)))))
(assert (= ($Snap.first ($Snap.second $t@62@05)) $Snap.unit))
; [eval] Measure$check(_caller_measures_13, _cthread_13, 1)
(push) ; 2
(pop) ; 2
; Joined path conditions
(assert (Measure$check $Snap.unit _caller_measures_13@57@05 _cthread_13@56@05 1))
(assert (=
  ($Snap.second ($Snap.second $t@62@05))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@62@05)))
    ($Snap.second ($Snap.second ($Snap.second $t@62@05))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@62@05))) $Snap.unit))
; [eval] issubtype(typeof(_cthread_13), Thread_0())
; [eval] typeof(_cthread_13)
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_13@56@05) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@62@05)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@62@05))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@62@05)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@62@05))))
  $Snap.unit))
...
; [eval] typeof(self)
(assert (issubtype<Bool> (typeof<PyType> self@59@05) (list<PyType> (list_arg<PyType> (typeof<PyType> self@59@05) 0))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@62@05))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@62@05)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@62@05))))))))
(set-option :timeout 0)
(push) ; 2
(assert (not (not (= 10 0))))
(check-sat)
...
; 0.00s
; (get-info :all-statistics)
(assert (not (= self@59@05 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@62@05)))))
  $Snap.unit))
; State saturation: after contract
...
; unknown
(push) ; 2
(declare-const $t@63@05 $Snap)
(assert (= $t@63@05 ($Snap.combine ($Snap.first $t@63@05) ($Snap.second $t@63@05))))
(assert (= ($Snap.first $t@63@05) $Snap.unit))
; [eval] (forperm _r_60: Ref [_r_60.MustReleaseBounded] :: Level(_r_60) <= _current_wait_level_13)
(assert (=
  ($Snap.second $t@63@05)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@63@05))
    ($Snap.second ($Snap.second $t@63@05)))))
(assert (= ($Snap.first ($Snap.second $t@63@05)) $Snap.unit))
; [eval] (forperm _r_60: Ref [_r_60.MustReleaseUnbounded] :: Level(_r_60) <= _current_wait_level_13)
(assert (=
  ($Snap.second ($Snap.second $t@63@05))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@63@05)))
    ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@63@05))) $Snap.unit))
; [eval] _residue_13 <= _current_wait_level_13
(assert (<= _residue_13@58@05 _current_wait_level_13@60@05))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@63@05)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@63@05))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@63@05))))
  $Snap.unit))
; [eval] _res != self
(assert (not (= _res@61@05 self@59@05)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))
(set-option :timeout 0)
(push) ; 3
(assert (not (not (= 20 0))))
(check-sat)
...
; 0.00s
; (get-info :all-statistics)
(assert (not (= _res@61@05 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))
(push) ; 3
(assert (not (not (= 20 0))))
(check-sat)
; unsat
...
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))
  $Snap.unit))
; [eval] _res.list_acc == self.list_acc
(assert (Seq_equal
  ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))
  ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))
  $Snap.unit))
; [eval] _res.__container == self
(assert (=
  ($SortWrappers.$SnapTo$Ref ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))
  self@59@05))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))
  $Snap.unit))
; [eval] _res.__iter_index == 0
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))
  0))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))))))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05))))))))))))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))))
  $Snap.unit))
...
; [eval] Seq[Ref]()
(assert (Seq_equal
  ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))))
  (as Seq_empty  Seq<$Ref>)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@63@05)))))))))))))
  $Snap.unit))
...
; [eval] list_arg(typeof(self), 0)
; [eval] typeof(self)
(assert (issubtype<Bool> (typeof<PyType> _res@61@05) (Iterator<PyType> (list_arg<PyType> (typeof<PyType> self@59@05) 0))))
(pop) ; 2
(push) ; 2
; [exec]
; var _cwl_13: Perm
(declare-const _cwl_13@64@05 $Perm)
; [exec]
; inhale false
(pop) ; 2
(pop) ; 1
