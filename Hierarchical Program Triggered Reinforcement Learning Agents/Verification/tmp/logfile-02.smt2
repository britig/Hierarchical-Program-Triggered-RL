...
; ------------------------------------------------------------
; ---------- Agent__is_light_red ----------
(declare-const _cthread_161@0@02 $Ref)
(declare-const _caller_measures_161@1@02 Seq<Measure$>)
(declare-const _residue_161@2@02 $Perm)
(declare-const self_4@3@02 $Ref)
(declare-const light_List@4@02 $Ref)
(declare-const _current_wait_level_161@5@02 $Perm)
(declare-const _res@6@02 $Ref)
(declare-const _cthread_161@7@02 $Ref)
(declare-const _caller_measures_161@8@02 Seq<Measure$>)
(declare-const _residue_161@9@02 $Perm)
(declare-const self_4@10@02 $Ref)
(declare-const light_List@11@02 $Ref)
(declare-const _current_wait_level_161@12@02 $Perm)
(declare-const _res@13@02 $Ref)
(push) ; 1
...
(assert (not (= _cthread_161@7@02 $Ref.null)))
(assert (=
  ($Snap.second $t@14@02)
  ($Snap.combine
...
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_161@7@02) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second $t@14@02))
  ($Snap.combine
...
; [eval] typeof(self_4)
; [eval] Agent()
(assert (issubtype<Bool> (typeof<PyType> self_4@10@02) (as Agent<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@14@02)))
  ($Snap.combine
...
; [eval] list(str())
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> light_List@11@02) (list<PyType> (as str<PyType>  PyType))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))
  ($Snap.combine
...
(assert (=
  ...
  $Snap.unit))
; [eval] self_4 != null
(assert (not (= self_4@10@02 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02)))))
  ($Snap.combine
...
(assert (not (= light_List@11@02 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))
  $Snap.unit))
...
(assert (= ($Snap.first ($Snap.second $t@15@02)) $Snap.unit))
...
(assert (<= _residue_161@9@02 _current_wait_level_161@12@02))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@15@02)))
  ($Snap.combine
...
; [eval] typeof(_res)
; [eval] bool()
(assert (issubtype<Bool> (typeof<PyType> _res@13@02) (as bool<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@15@02))))
  $Snap.unit))
(pop) ; 2
...
; [exec]
; var _err: Ref
(declare-const _err@16@02 $Ref)
; [exec]
; var self_12: Ref
(declare-const self_12@17@02 $Ref)
; [exec]
; var light_List_0: Ref
(declare-const light_List_0@18@02 $Ref)
; [exec]
; var _cwl_161: Perm
(declare-const _cwl_161@19@02 $Perm)
; [exec]
; var _method_measures_161: Seq[Measure$]
(declare-const _method_measures_161@20@02 Seq<Measure$>)
; [exec]
; _method_measures_161 := Seq[Measure$]()
; [eval] Seq[Measure$]()
; [exec]
; inhale typeof(self_4) == Agent()
(declare-const $t@21@02 $Snap)
(assert (= $t@21@02 $Snap.unit))
; [eval] typeof(self_4) == Agent()
; [eval] typeof(self_4)
; [eval] Agent()
(assert (= (typeof<PyType> self_4@10@02) (as Agent<PyType>  PyType)))
...
; self_12 := self_4
; [exec]
; light_List_0 := light_List
; [eval] list___contains__(light_List_0, str___create__(1, 99))
...
(push) ; 4
(assert (not (issubtype<Bool> (typeof<PyType> light_List@11@02) (list<PyType> (list_arg<PyType> (typeof<PyType> light_List@11@02) 0)))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> light_List@11@02) (list<PyType> (list_arg<PyType> (typeof<PyType> light_List@11@02) 0))))
...
(assert (<= $Perm.No (- $Perm.Write $k@22@02)))
(assert (<= (- $Perm.Write $k@22@02) $Perm.Write))
(assert (implies
  (< $Perm.No (- $Perm.Write $k@22@02))
  (not (= light_List@11@02 $Ref.null))))
(pop) ; 3
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> light_List@11@02) (list<PyType> (list_arg<PyType> (typeof<PyType> light_List@11@02) 0)))
  ($Perm.isReadVar $k@22@02 $Perm.Write)
  (< $k@22@02 $Perm.Write)
  (<= $Perm.No (- $Perm.Write $k@22@02))
  (<= (- $Perm.Write $k@22@02) $Perm.Write)
  (implies
    (< $Perm.No (- $Perm.Write $k@22@02))
    (not (= light_List@11@02 $Ref.null)))))
(push) ; 3
(assert (not (not
  (list___contains__ ($Snap.combine
    $Snap.unit
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))) light_List@11@02 (str___create__ $Snap.unit 1 99)))))
(check-sat)
; unknown
(pop) ; 3
; 0.01s
...
; 0.01s
; (get-info :all-statistics)
; [then-branch: 0 | list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:($t@14@02))))))), light_List@11@02, str___create__(_, 1, 99)) | live]
; [else-branch: 0 | !(list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:($t@14@02))))))), light_List@11@02, str___create__(_, 1, 99))) | live]
(push) ; 3
; [then-branch: 0 | list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:($t@14@02))))))), light_List@11@02, str___create__(_, 1, 99))]
...
(pop) ; 4
; Joined path conditions
(declare-const _res@23@02 $Ref)
(assert (= _res@23@02 (__prim__bool___box__ $Snap.unit true)))
; [exec]
; label __end
; [eval] issubtype(typeof(_res), bool())
; [eval] typeof(_res)
...
(set-option :timeout 0)
(push) ; 4
(assert (not (issubtype<Bool> (typeof<PyType> _res@23@02) (as bool<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> _res@23@02) (as bool<PyType>  PyType)))
; [eval] (forperm _r_38: Ref [MustInvokeBounded(_r_38)] :: false)
; [eval] (forperm _r_38: Ref [MustInvokeUnbounded(_r_38)] :: false)
; [eval] (forperm _r_38: Ref [_r_38.MustReleaseBounded] :: false)
; [eval] (forperm _r_38: Ref [_r_38.MustReleaseUnbounded] :: false)
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:($t@14@02))))))), light_List@11@02, str___create__(_, 1, 99)))]
(assert (not
  (list___contains__ ($Snap.combine
    $Snap.unit
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))) light_List@11@02 (str___create__ $Snap.unit 1 99))))
...
(push) ; 4
(assert (not (or (= $k@24@02 $Perm.No) (< $Perm.No $k@24@02))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
(assert (< $k@24@02 $Perm.Write))
(assert (<= $Perm.No (- $Perm.Write $k@24@02)))
(assert (<= (- $Perm.Write $k@24@02) $Perm.Write))
(assert (implies
  (< $Perm.No (- $Perm.Write $k@24@02))
  (not (= light_List@11@02 $Ref.null))))
(pop) ; 3
; Joined path conditions
(assert (and
  ($Perm.isReadVar $k@24@02 $Perm.Write)
  (< $k@24@02 $Perm.Write)
  (<= $Perm.No (- $Perm.Write $k@24@02))
  (<= (- $Perm.Write $k@24@02) $Perm.Write)
  (implies
    (< $Perm.No (- $Perm.Write $k@24@02))
    (not (= light_List@11@02 $Ref.null)))))
(push) ; 3
...
; 0.01s
; (get-info :all-statistics)
; [then-branch: 1 | !(list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:($t@14@02))))))), light_List@11@02, str___create__(_, 1, 99))) | live]
; [else-branch: 1 | list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:($t@14@02))))))), light_List@11@02, str___create__(_, 1, 99)) | live]
(push) ; 3
; [then-branch: 1 | !(list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:($t@14@02))))))), light_List@11@02, str___create__(_, 1, 99)))]
(assert (not
  (list___contains__ ($Snap.combine
    $Snap.unit
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))) light_List@11@02 (str___create__ $Snap.unit 1 99))))
...
(pop) ; 4
; Joined path conditions
(declare-const _res@25@02 $Ref)
(assert (= _res@25@02 (__prim__bool___box__ $Snap.unit false)))
; [exec]
; label __end
; [eval] issubtype(typeof(_res), bool())
; [eval] typeof(_res)
...
(set-option :timeout 0)
(push) ; 4
(assert (not (issubtype<Bool> (typeof<PyType> _res@25@02) (as bool<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> _res@25@02) (as bool<PyType>  PyType)))
; [eval] (forperm _r_38: Ref [MustInvokeBounded(_r_38)] :: false)
; [eval] (forperm _r_38: Ref [MustInvokeUnbounded(_r_38)] :: false)
; [eval] (forperm _r_38: Ref [_r_38.MustReleaseBounded] :: false)
; [eval] (forperm _r_38: Ref [_r_38.MustReleaseUnbounded] :: false)
(pop) ; 3
(push) ; 3
; [else-branch: 1 | list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:($t@14@02))))))), light_List@11@02, str___create__(_, 1, 99))]
(assert (list___contains__ ($Snap.combine
  $Snap.unit
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@02))))))) light_List@11@02 (str___create__ $Snap.unit 1 99)))
(pop) ; 3
