...
; ------------------------------------------------------------
; ---------- NNAgent__is_light_red_inherit_check ----------
(declare-const _cthread_161@0@06 $Ref)
(declare-const _caller_measures_161@1@06 Seq<Measure$>)
(declare-const _residue_161@2@06 $Perm)
(declare-const self_4@3@06 $Ref)
(declare-const light_List@4@06 $Ref)
(declare-const _current_wait_level_161@5@06 $Perm)
(declare-const _res@6@06 $Ref)
(declare-const _cthread_161@7@06 $Ref)
(declare-const _caller_measures_161@8@06 Seq<Measure$>)
(declare-const _residue_161@9@06 $Perm)
(declare-const self_4@10@06 $Ref)
(declare-const light_List@11@06 $Ref)
(declare-const _current_wait_level_161@12@06 $Perm)
(declare-const _res@13@06 $Ref)
(push) ; 1
...
(assert (not (= _cthread_161@7@06 $Ref.null)))
(assert (=
  ($Snap.second $t@14@06)
  ($Snap.combine
...
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_161@7@06) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second $t@14@06))
  ($Snap.combine
...
; [eval] self_4 != null
(assert (not (= self_4@10@06 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@14@06)))
  ($Snap.combine
...
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@14@06))))
  $Snap.unit))
; [eval] typeof(self_4) == NNAgent()
; [eval] typeof(self_4)
; [eval] NNAgent()
(assert (= (typeof<PyType> self_4@10@06) (as NNAgent<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))
  ($Snap.combine
...
; [eval] typeof(self_4)
; [eval] Agent()
(assert (issubtype<Bool> (typeof<PyType> self_4@10@06) (as Agent<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06)))))
  ($Snap.combine
...
; [eval] list(str())
; [eval] str()
(assert (issubtype<Bool> (typeof<PyType> light_List@11@06) (list<PyType> (as str<PyType>  PyType))))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))
  ($Snap.combine
...
(assert (not (= light_List@11@06 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))))
  $Snap.unit))
...
; unknown
(push) ; 2
(declare-const $t@15@06 $Snap)
(assert (= $t@15@06 ($Snap.combine ($Snap.first $t@15@06) ($Snap.second $t@15@06))))
(assert (= ($Snap.first $t@15@06) $Snap.unit))
; [eval] (forperm _r_25: Ref [_r_25.MustReleaseBounded] :: Level(_r_25) <= _current_wait_level_161)
(assert (=
  ($Snap.second $t@15@06)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@15@06))
    ($Snap.second ($Snap.second $t@15@06)))))
(assert (= ($Snap.first ($Snap.second $t@15@06)) $Snap.unit))
; [eval] (forperm _r_25: Ref [_r_25.MustReleaseUnbounded] :: Level(_r_25) <= _current_wait_level_161)
(assert (=
  ($Snap.second ($Snap.second $t@15@06))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second $t@15@06)))
    ($Snap.second ($Snap.second ($Snap.second $t@15@06))))))
(assert (= ($Snap.first ($Snap.second ($Snap.second $t@15@06))) $Snap.unit))
; [eval] _residue_161 <= _current_wait_level_161
(assert (<= _residue_161@9@06 _current_wait_level_161@12@06))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@15@06)))
  ($Snap.combine
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@15@06))))
    ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@15@06)))))))
(assert (=
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second $t@15@06))))
  $Snap.unit))
...
; [eval] typeof(_res)
; [eval] bool()
(assert (issubtype<Bool> (typeof<PyType> _res@13@06) (as bool<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@15@06))))
  $Snap.unit))
(pop) ; 2
...
; [exec]
; var _cwl_161: Perm
(declare-const _cwl_161@16@06 $Perm)
; [exec]
; var _method_measures_161: Seq[Measure$]
(declare-const _method_measures_161@17@06 Seq<Measure$>)
; [exec]
; _method_measures_161 := Seq[Measure$]()
; [eval] Seq[Measure$]()
; [eval] list___contains__(light_List, str___create__(1, 99))
...
(push) ; 4
(assert (not (issubtype<Bool> (typeof<PyType> light_List@11@06) (list<PyType> (list_arg<PyType> (typeof<PyType> light_List@11@06) 0)))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> light_List@11@06) (list<PyType> (list_arg<PyType> (typeof<PyType> light_List@11@06) 0))))
...
(assert (<= $Perm.No (- $Perm.Write $k@18@06)))
(assert (<= (- $Perm.Write $k@18@06) $Perm.Write))
(assert (implies
  (< $Perm.No (- $Perm.Write $k@18@06))
  (not (= light_List@11@06 $Ref.null))))
(pop) ; 3
; Joined path conditions
(assert (and
  (issubtype<Bool> (typeof<PyType> light_List@11@06) (list<PyType> (list_arg<PyType> (typeof<PyType> light_List@11@06) 0)))
  ($Perm.isReadVar $k@18@06 $Perm.Write)
  (< $k@18@06 $Perm.Write)
  (<= $Perm.No (- $Perm.Write $k@18@06))
  (<= (- $Perm.Write $k@18@06) $Perm.Write)
  (implies
    (< $Perm.No (- $Perm.Write $k@18@06))
    (not (= light_List@11@06 $Ref.null)))))
(push) ; 3
(assert (not (not
  (list___contains__ ($Snap.combine
    $Snap.unit
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))))) light_List@11@06 (str___create__ $Snap.unit 1 99)))))
(check-sat)
; unknown
(pop) ; 3
; 0.01s
...
; 0.01s
; (get-info :all-statistics)
; [then-branch: 0 | list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:(Second:(Second:($t@14@06))))))))), light_List@11@06, str___create__(_, 1, 99)) | live]
; [else-branch: 0 | !(list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:(Second:(Second:($t@14@06))))))))), light_List@11@06, str___create__(_, 1, 99))) | live]
(push) ; 3
; [then-branch: 0 | list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:(Second:(Second:($t@14@06))))))))), light_List@11@06, str___create__(_, 1, 99))]
...
(pop) ; 4
; Joined path conditions
(declare-const _res@19@06 $Ref)
(assert (= _res@19@06 (__prim__bool___box__ $Snap.unit true)))
; [exec]
; label __end_1
; [eval] issubtype(typeof(_res), bool())
; [eval] typeof(_res)
...
(set-option :timeout 0)
(push) ; 4
(assert (not (issubtype<Bool> (typeof<PyType> _res@19@06) (as bool<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> _res@19@06) (as bool<PyType>  PyType)))
...
(pop) ; 3
(push) ; 3
; [else-branch: 0 | !(list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:(Second:(Second:($t@14@06))))))))), light_List@11@06, str___create__(_, 1, 99)))]
(assert (not
  (list___contains__ ($Snap.combine
    $Snap.unit
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))))) light_List@11@06 (str___create__ $Snap.unit 1 99))))
...
; [eval] list_arg(typeof(self), 0)
; [eval] typeof(self)
(declare-const $k@20@06 $Perm)
(assert ($Perm.isReadVar $k@20@06 $Perm.Write))
(push) ; 4
(assert (not (or (= $k@20@06 $Perm.No) (< $Perm.No $k@20@06))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
...
; 0.00s
; (get-info :all-statistics)
(assert (< $k@20@06 $Perm.Write))
(assert (<= $Perm.No (- $Perm.Write $k@20@06)))
(assert (<= (- $Perm.Write $k@20@06) $Perm.Write))
(assert (implies
  (< $Perm.No (- $Perm.Write $k@20@06))
  (not (= light_List@11@06 $Ref.null))))
(pop) ; 3
; Joined path conditions
(assert (and
  ($Perm.isReadVar $k@20@06 $Perm.Write)
  (< $k@20@06 $Perm.Write)
  (<= $Perm.No (- $Perm.Write $k@20@06))
  (<= (- $Perm.Write $k@20@06) $Perm.Write)
  (implies
    (< $Perm.No (- $Perm.Write $k@20@06))
    (not (= light_List@11@06 $Ref.null)))))
(push) ; 3
...
; 0.01s
; (get-info :all-statistics)
; [then-branch: 1 | !(list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:(Second:(Second:($t@14@06))))))))), light_List@11@06, str___create__(_, 1, 99))) | live]
; [else-branch: 1 | list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:(Second:(Second:($t@14@06))))))))), light_List@11@06, str___create__(_, 1, 99)) | live]
(push) ; 3
; [then-branch: 1 | !(list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:(Second:(Second:($t@14@06))))))))), light_List@11@06, str___create__(_, 1, 99)))]
(assert (not
  (list___contains__ ($Snap.combine
    $Snap.unit
    ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))))) light_List@11@06 (str___create__ $Snap.unit 1 99))))
...
(pop) ; 4
; Joined path conditions
(declare-const _res@21@06 $Ref)
(assert (= _res@21@06 (__prim__bool___box__ $Snap.unit false)))
; [exec]
; label __end_1
; [eval] issubtype(typeof(_res), bool())
; [eval] typeof(_res)
...
(set-option :timeout 0)
(push) ; 4
(assert (not (issubtype<Bool> (typeof<PyType> _res@21@06) (as bool<PyType>  PyType))))
(check-sat)
; unsat
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (issubtype<Bool> (typeof<PyType> _res@21@06) (as bool<PyType>  PyType)))
; [eval] (forperm _r_26: Ref [MustInvokeBounded(_r_26)] :: false)
; [eval] (forperm _r_26: Ref [MustInvokeUnbounded(_r_26)] :: false)
; [eval] (forperm _r_26: Ref [_r_26.MustReleaseBounded] :: false)
; [eval] (forperm _r_26: Ref [_r_26.MustReleaseUnbounded] :: false)
(pop) ; 3
(push) ; 3
; [else-branch: 1 | list___contains__((_, First:(Second:(Second:(Second:(Second:(Second:(Second:(Second:($t@14@06))))))))), light_List@11@06, str___create__(_, 1, 99))]
(assert (list___contains__ ($Snap.combine
  $Snap.unit
  ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@14@06))))))))) light_List@11@06 (str___create__ $Snap.unit 1 99)))
(pop) ; 3
...
(pop) ; 1
; ---------- range___iter__ ----------
(declare-const _cthread_148@22@06 $Ref)
(declare-const _caller_measures_148@23@06 Seq<Measure$>)
(declare-const _residue_148@24@06 $Perm)
(declare-const self@25@06 $Ref)
(declare-const _current_wait_level_148@26@06 $Perm)
(declare-const _res@27@06 $Ref)
(declare-const _cthread_148@28@06 $Ref)
(declare-const _caller_measures_148@29@06 Seq<Measure$>)
(declare-const _residue_148@30@06 $Perm)
(declare-const self@31@06 $Ref)
(declare-const _current_wait_level_148@32@06 $Perm)
(declare-const _res@33@06 $Ref)
(push) ; 1
...
(assert (not (= _cthread_148@28@06 $Ref.null)))
(assert (=
  ($Snap.second $t@34@06)
  ($Snap.combine
    ($Snap.first ($Snap.second $t@34@06))
    ($Snap.second ($Snap.second $t@34@06)))))
(assert (= ($Snap.first ($Snap.second $t@34@06)) $Snap.unit))
; [eval] Measure$check(_caller_measures_148, _cthread_148, 1)
(push) ; 2
(pop) ; 2
; Joined path conditions
(assert (Measure$check $Snap.unit _caller_measures_148@29@06 _cthread_148@28@06 1))
(assert (=
  ($Snap.second ($Snap.second $t@34@06))
  ($Snap.combine
...
; [eval] Thread_0()
(assert (issubtype<Bool> (typeof<PyType> _cthread_148@28@06) (as Thread_0<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@34@06)))
  ($Snap.combine
...
; [eval] typeof(self)
; [eval] range()
(assert (issubtype<Bool> (typeof<PyType> self@31@06) (as range<PyType>  PyType)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@34@06))))
  $Snap.unit))
; State saturation: after contract
...
(assert (= ($Snap.first $t@35@06) $Snap.unit))
...
(assert (<= _residue_148@30@06 _current_wait_level_148@32@06))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second $t@35@06)))
  ($Snap.combine
...
(assert (=
  ...
  $Snap.unit))
; [eval] _res != self
(assert (not (= _res@33@06 self@31@06)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@35@06))))
  ($Snap.combine
...
; 0.00s
; (get-info :all-statistics)
(assert (not (= _res@33@06 $Ref.null)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@35@06)))))
  ($Snap.combine
...
; Joined path conditions
(assert (Seq_equal
  ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@35@06))))))
  (range___sil_seq__ $Snap.unit self@31@06)))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@35@06))))))
  ($Snap.combine
...
(assert (=
  ($SortWrappers.$SnapToInt ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@35@06))))))))))
  0))
(assert (=
  ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@35@06))))))))))
  ($Snap.combine
...
; [eval] Seq[Ref]()
(assert (Seq_equal
  ($SortWrappers.$SnapToSeq<$Ref> ($Snap.first ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second ($Snap.second $t@35@06))))))))))))
  (as Seq_empty  Seq<$Ref>)))
(pop) ; 2
(push) ; 2
; [exec]
; var _cwl_148: Perm
(declare-const _cwl_148@36@06 $Perm)
; [exec]
; inhale false
(pop) ; 2
(pop) ; 1
